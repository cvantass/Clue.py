...
#The Deck
rooms = ['barbara\'s office', 'the side office', 'the reading room', 'the stacks',
         'the grove', 'David Geffen Hall', 'the orchestra pit', 'the freight elevator',
         'the Juilliard cafeteria', 'Gourmet Garage']

weapons = ['the Grammy', 'the broken record', 'the baton',
           'Gabe\'s heart attack-inducing phone answering voice',
           'endless hours of data entry']

names = ['Barbara', 'Gabe', 'EJ', 'Ian', 'Sarah',
         'Isaiah', 'Leanora', 'Will', 'Charles']
...
print()
print()
print("Welcome to Clue: Philharmonic Archives Edition!")
print()
sys.stdout.flush()
time.sleep(1)
print("The Music Director, Jaap van Zweden has been found dead!")
print()
sys.stdout.flush()
time.sleep(2)
...
sys.stdout.flush()
time.sleep(2)
print("What's that? You're still just an intern? This is above your paygrade?")
print("Well too bad! it's time to close out of DBText and solve this mystery!")
print()
print()
sys.stdout.flush()
time.sleep(3)
